# ============================================================
# SendDailySales_SYNC_7DAYS_v5.ps1
# 
...
# ✅ NO WARNINGS: Suppress all PowerShell warnings
# ============================================================
...
# Suppress warnings at script start
...
Write-Host ""
Write-Host "🔄 Daily Sales SYNC 7 DAYS v5 - Auto-Detect Stores (No Warnings)" -ForegroundColor Cyan
...
"@
        ...
        try {
            ...
            try {
                ...
                # Suppress warnings for Firebase API call
                $previousWarnPref = $WarningPreference
                $WarningPreference = 'SilentlyContinue'
                ...
                $WarningPreference = $previousWarnPref
                
                Write-Host "   ✅ Firebase: Success! ($($response.StatusCode))" -ForegroundColor Green
                ...
                Write-Host "   ❌ Firebase: FAILED - $_" -ForegroundColor Red
